...
//Array is a collection of elements of a single type. It can be used to hold multiple values at once.
//We can get the required value by using an index. Those can't shrink to grow.
