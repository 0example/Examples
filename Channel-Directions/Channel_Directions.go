...
//This means you can both send and recieve data using the channel.
//But you can change the channel direction as recieve-only or send-only according to the situation.
