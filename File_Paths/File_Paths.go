...
//In Go language, package filepath implements utility routines for manipulating filename paths in a way compatible 
//with the target operating system-defined file paths.
//Example : 
//		On Linux :	/home/RobPike
//		On Windows :\Users\RobPike
...
func main() {
	...
	fmt.Println("Spliting of path(0example\\golang\\filepath.go):",d,b )
